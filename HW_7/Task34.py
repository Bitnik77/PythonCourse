...
phrase = input('Введите кричалку: ').lower()

lst = ['а', 'е', 'ё', 'и', 'о', 'у', 'э', 'ю', 'я', ' ']


def func(x, y):
    list_1 = set(''.join(filter(lambda item: item in lst, phrase)).split())
    if len(list_1) == 1:
        print('Парам пам-пам')
    else:
        print('Пам парам')
...
func(lst, phrase)
# не смог сделать, когда в фразе есть разные гласные, тут только если какая-то одна из списка(
